...
Pour aller plus loin : [Mode swarm : orchestrer des agents Claude avec tmux](/fr/blog/claude-code-agent-teams-tmux). Setup tmux, commande `/swarm`, et workflow multi-agents.
