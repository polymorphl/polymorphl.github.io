...
Il y a un peu plus de trois ans, j’ai lancé GitHub Copilot pour la première fois. Curieux mais sceptique, je ne croyais pas qu’il allait transformer ma façon de coder.
...
En 2022, Copilot c'était essentiellement de l'autocomplétion. Pas de fenêtre de chat, pas de conversation : juste des suggestions qui apparaissaient au fil de ta frappe, comme un tab intelligent.
